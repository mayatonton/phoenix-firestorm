...
**作成日**: 2026-06-03
**起源 handoff**: `handoff-substep-4-3-gamma-prime-port-beta-2-bundle-B-B-eta-28-pivot-to-ubo-design.md`
...
### A.3 参照 handoff doc
- `handoff-substep-4-3-gamma-prime-port-beta-2-bundle-B-B-eta-28-pivot-to-ubo-design.md` (本 pivot の経緯資料)
- `handoff-substep-4-3-gamma-prime-port-beta-2-bundle-B-B-eta-28-phase2d-alpha-prep.md` (Phase 2d-α 前 prep doc、本 pivot で前提変更)
