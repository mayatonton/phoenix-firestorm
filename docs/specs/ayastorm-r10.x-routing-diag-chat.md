...
**仕様**: `docs/specs/spec_5_1ch_placement.md` §4.4 / §13.7
...
**作業**:
- `docs/specs/spec_5_1ch_placement.md` §4.4.1 を 5 ケース表形式に整理 (各 emit 文言を確定)
...
- `docs/specs/spec_5_1ch_placement.md` (§4.4.3 設定 UI 位置を実装ファイル名/コントロール名で確定 / §4.4.1 / §13.7 文言は EN 固定 + 多言語化将来課題に修正)
...
| 項目 | 参照先 |
|---|---|
| r10.x スコープ / 互換性 | `docs/specs/spec_5_1ch_placement.md` §13.7 |
| chat 通知 5 ケース文言表 | `docs/specs/spec_5_1ch_placement.md` §4.4.1 |
| throttle key 仕様 | `docs/specs/spec_5_1ch_placement.md` §4.4.2 |
| 設定 UI 位置 | `docs/specs/spec_5_1ch_placement.md` §4.4.3 |
| 設定キー一覧 | `docs/specs/spec_5_1ch_placement.md` §6 |
