...
**ファイル**:
- `docs/archive/r10/gen_test_material.sh` (新規スクリプト)
...
**完了条件**: `bash docs/archive/r10/gen_test_material.sh` で `test_routing_5_1.ogg` が再現可能 / AYA Icecast 経由で viewer から再生確認。
...
| 項目 | 参照先 |
|---|---|
| リスク R1〜R5 (内容 + 対策方針) | `docs/specs/spec_5_1ch_placement.md` §8 |
| 受入条件表 (実測値含む) | `docs/specs/spec_5_1ch_placement.md` §5.3 |
| 実装サマリ (commit hash 一覧) | `docs/specs/spec_5_1ch_placement.md` §13.1 |
| §5.3 安定性指標まとめ | `docs/specs/spec_5_1ch_placement.md` §13.2 |
| P9 検証中発見の bug A/B 詳細 | `docs/specs/spec_5_1ch_placement.md` §13.3 |
| codec 別 end-to-end 検証状況 | `docs/specs/spec_5_1ch_placement.md` §13.4 |
| 既知の運用上の制約 | `docs/specs/spec_5_1ch_placement.md` §13.5 |
| r11 への持ち越し | `docs/specs/spec_5_1ch_placement.md` §13.6 |
| 残課題・将来拡張 | `docs/specs/spec_5_1ch_placement.md` §9 |
