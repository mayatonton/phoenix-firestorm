...
| 項目 | 参照先 |
|---|---|
| リスク R1〜R8 (内容 + 対策方針) | `docs/specs/spec_5_1ch_source.md` §8 |
| 受入条件表 (機能要件 F1〜F8) | `docs/specs/spec_5_1ch_source.md` §5.1 |
| 安定性指標表 (実測値含む) | `docs/specs/spec_5_1ch_source.md` §5.3 |
| 実装サマリ (commit hash 一覧) | `docs/specs/spec_5_1ch_source.md` §12.1 |
| codec 別 end-to-end 検証状況 | `docs/specs/spec_5_1ch_source.md` §12.3 |
| 既知の運用上の制約 | `docs/specs/spec_5_1ch_source.md` §12.4 |
| r10 への持ち越し | `docs/specs/spec_5_1ch_source.md` §12.6 |
| 残課題・スコープ外 | `docs/specs/spec_5_1ch_source.md` §9 / §12.6 |
