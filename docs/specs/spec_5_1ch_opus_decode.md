...
> **前提**: `docs/specs/spec_5_1ch_source.md` (r9 5.1ch ソース受入仕様)
...
- `docs/guides/lsl/aya_3dstream_setup.lsl` — タグ書式は同じ
...
- 3p-fmodstudio fork (`mayatonton/3p-fmodstudio`) は AYAstorm リリースの暗黙依存になったため、build doc (`docs/build/building_ayastorm.md`) の clone URL を fork に更新済 (`26f5d04f27`)
