...
> **前提 (実装基盤)**: `docs/specs/spec_stream3d_decode_thread.md` (r7 decode thread 化)
...
→ **詳細は `docs/specs/spec_5_1ch_placement.md` (r10 仕様書) を参照**
...
| Opus 6ch | ✓ 完了 (r9-opus 補完) | r9 時点では FMOD 同梱 codec に Opus が無く未検証だったが、r9-opus (`docs/specs/spec_5_1ch_opus_decode.md`) で codec plugin を実装し実機 Icecast (`go-stream-live.com:8030/stream`) で 5.1 surround の再生 + 6ch downmix を確認 |
...
→ **`docs/specs/spec_5_1ch_placement.md` (r10 仕様書) に移管**
