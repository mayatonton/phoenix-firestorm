...
### B 軸候補 (r19+)
- **薄物の透過 (r19 起票中)**: 葉が太陽に向かって透ける / 白布カーテン裏に光が回る / 人物の耳が透ける、wrap-around diffuse 系の back light 簡易透過。instant A/B で視認可能な視覚インパクト。spec: `docs/ayastorm-r19-translucency.md`
