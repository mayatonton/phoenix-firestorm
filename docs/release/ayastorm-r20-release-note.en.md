...
Implementation details / known limits / configuration reference live in the permanent spec (`docs/specs/spec_avatar_skin_sss.md`). This note is link-only + diff highlights.
...
- r20 full spec (Phase A–E status, identifier strategy comparison, debug-settings restore guide): `docs/specs/spec_avatar_skin_sss.md`
