    ...
    mProgressViewMini(NULL)
{
    ...
    */
    ...
    LLImageGL::initClass(LLViewerTexture::MAX_GL_IMAGE_CATEGORY, false, gSavedSettings.getBOOL("RenderGLMultiThreadedTextures"), gSavedSettings.getBOOL("RenderGLMultiThreadedMedia"));
    gTextureList.init();
