...
layout(location = 2) out vec2 base_color_texcoord;
layout(location = 3) out vec2 normal_texcoord;
layout(location = 4) out vec2 metallic_roughness_texcoord;
layout(location = 5) out vec2 emissive_texcoord;
