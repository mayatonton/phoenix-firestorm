...
layout(set = 1, binding = 19) uniform sampler2D diffuseRect;
layout(set = 1, binding = 20) uniform sampler2D specularRect;

#if defined(HAS_EMISSIVE)
layout(set = 1, binding = 21) uniform sampler2D emissiveRect;
#endif
#else
