...
// PerDrawUBO_AvatarVelocity blueprint (= set=2 binding=0, cadence=PerDraw)
// Source: literal extract from class1/deferred/avatarVelocityV.glsl:53 ifdef LL_VULKAN_GLSL block (single site)
...
layout(std140, set = 2, binding = 0) uniform PerDrawUBO_AvatarVelocity
{
