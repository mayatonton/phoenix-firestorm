...
// <FS:AYA r20 → r30> LLPanelPreferenceSSS は AYAstorm Controls (Alt+C) の Skin SSS タブに
// 移設 (2026-05-24)。Lock/ResetAll callback は llviewermenu.cpp の AYASSSToggleLock /
// AYASSSResetAll、D-button は AYAResetCinematic + parityTable。
