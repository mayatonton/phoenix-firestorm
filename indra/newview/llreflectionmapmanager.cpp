...
void load_exr(const std::string& filename)
{
    ...
    {
        gEXRImage = new LLImageGL(4, GL_TEXTURE_2D, GL_RGB16F, GL_RGB16F, GL_FLOAT, LLTexUnit::TAM_CLAMP);
...
void LLReflectionMapManager::getReflectionMaps(std::vector<LLReflectionMap*>& maps)
{
    ...
    {
        mProbes[i]->mLastBindTime = gFrameTimeSeconds;
